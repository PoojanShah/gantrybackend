...
@section('content')
    ...
    <script>
        <?php if($data['success'] == 'Successfully updated!') { ?> //To write such a shit you should be really talented !!!!!
        setTimeout(function () {
            blogEdited();
        }, 1000);
        <?php } ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form action="/admin/video/edit/<?= $data['video']->id; ?>/" method="post"
                        ...
                        <div class="card-body row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" id="title" class="form-control"
                                           ...
                                           value="<?php if (isset($data['video']->title)) {
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="width:200px;" type="text" name="tag_1" class="form-control"
                                           placeholder="Tag 1" value="<?php if (isset($data['video']->tag_1)) {
                                        echo $data['video']->tag_1;
                                    } ?>">
                                    <input style="width:200px;" type="text" name="tag_2" class="form-control"
                                           placeholder="Tag 2" value="<?php if (isset($data['video']->tag_2)) {
                                        echo $data['video']->tag_2;
                                    } ?>">
                                    <input style="width:200px;" type="text" name="tag_3" class="form-control"
                                           placeholder="Tag 3" value="<?php if (isset($data['video']->tag_3)) {
                                        echo $data['video']->tag_3;
                                    } ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input style="width:200px;" type="text" name="sort" class="form-control"
                                           value="<?= $data['video']->sort ? $data['video']->sort : ''; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="date">Zoho addon alias</label>
                                    <input type="text" name="zoho_addon_code" class="form-control"
                                           value="<?= $data['video']->zoho_addon_code ? $data['video']->zoho_addon_code : ''; ?>"
                            ...
                            <div class="card-body" style="display: none">
                                <div class="form-group">
                                    ...
                                    <img <?php if(empty($data['video']->image)) { ?>style="display: none;"
                                         <?php } ?> src="<?= $data['video']->image; ?>" id="output_image"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <img <?php if(empty($data['video']->thumbnail)) { ?>style="display: none;"
                                         <?php } ?> src="<?= $data['video']->thumbnail; ?>" id="output_image2"
                                         class="create-event__file-preview"/>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <video controls
                                           style="width:300px; <?php if(empty($data['video']->video)) { ?>display: none;<?php } ?>">
                                        <source src="<?= $data['video']->video; ?>" type="video/mp4">
                                    </video>
                                    <?php } else { ?>
                                    <img <?php if(empty($data['video']->video)) { ?>style="display: none;"
                                         <?php } else {
                                             echo "style='width:100px;'";
                                         } ?> src="<?= $data['video']->video; ?>" id="outputs_image"
                                         class="create-event__file-preview"/>
                                    <?php } ?>
                                </div>
