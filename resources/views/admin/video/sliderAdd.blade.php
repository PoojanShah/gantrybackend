                            ...
                            <div class="card-body row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="subtitle" id="subtitle" class="form-control" placeholder="Enter Subtitle" value="<?php if(isset($data['request']['subtitle'])) { echo $data['request']['subtitle']; } ?>" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="subtitle">Text</label>
                                        <input type="text" name="subsubtitle" id="subsubtitle" class="form-control" placeholder="Enter Text" value="<?php if(isset($data['request']['subsubtitle'])) { echo $data['request']['subsubtitle']; } ?>" required>
                                    </div>
