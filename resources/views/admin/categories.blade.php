        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-6" style="text-align: right; color:#fff;">
                    <a href="/admin/categories/add/" class="btn btn-success">+ Добавить</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                    ...
                                    <?php if($data['categories']) { ?>
                                        ...
                                        foreach ($data['categories'] as $item) { ?>
                                            <tr>
                                                ...
                                                <td width="100px"><a href="/admin/categories/edit/<?= $item->id; ?>/" class="btn btn-primary btn-round">Edit</a></td>
                                                <td width="100px"><span onClick="deleteCategoryItem('<?= $item->id; ?>', $(this));" class="btn btn-danger btn-round"> × Delete</span></td>
                                            </tr>
                                        <?php $i++; } ?>
                                    <?php } ?>
                                </tbody>
