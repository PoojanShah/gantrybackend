...
<div class="main-panel">
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h4 class="page-title">Portfolio (<?= $data['count']; ?> items)</h4>
                ...
                <div class="col-md-6" style="text-align: right; color:#fff;">
                    <a href="/admin/portfolio/add/" class="btn btn-success">+ Add Item</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="card-body">
                            <table class="table table-head-bg-default table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <td width="100px"><a href="/admin/portfolio/edit/<?= $item->id; ?>/" class="btn btn-primary btn-round">Edit</a></td>
                                    <td width="100px"><span onClick="deletePortfolioItem('<?= $item->id; ?>', $(this));" class="btn btn-danger btn-round"> × Delete</span></td>
                                </tr>
                                <?php $i++; } ?>
                                <?php } ?>
                                </tbody>
