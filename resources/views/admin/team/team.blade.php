...
<div class="main-panel">
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h4 class="page-title">Team (<?= $data['count']; ?> employees)</h4>
                ...
                <div class="col-md-6" style="text-align: right; color:#fff;">
                    <a href="/admin/team/add/" class="btn btn-success">+ Add Item</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="card-body">
                            <table class="table table-head-bg-default table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <td width="100px"><a href="/admin/team/edit/<?= $item->id; ?>/" class="btn btn-primary btn-round">Edit</a></td>
                                    <td width="100px"><span onClick="deleteTeamItem('<?= $item->id; ?>', $(this));" class="btn btn-danger btn-round"> × Delete</span></td>
                                </tr>
                                <?php $i++; } ?>
                                <?php } ?>
                                </tbody>
