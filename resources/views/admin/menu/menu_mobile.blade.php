                            ...
                            <form id="menu_mobile_form" method="post">
                                        ...
                                        <?php if($data['menu']) { ?>
                                            ...
                                            foreach ($data['menu'] as $item) { ?>
                                                <tr>
                                                    ...
                                                    <td width="100px"><span onClick="deleteMenuMobileItem('<?= $item->id; ?>', $(this));" class="btn btn-danger btn-round"> × Delete</span></td>
                                                </tr>
                                            <?php $i++; } ?>
                                        <?php } ?>
                                    </tbody>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3" style="text-align: right;">
                                        <a id="add_button" onClick="addItemMobileMenu(<?= $i; ?>);" class="btn btn-default">+ Add Item</a>
                                    </div>
                                </div>
                            </form>
                        </div>
